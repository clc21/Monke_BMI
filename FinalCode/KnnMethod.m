classdef KnnMethod < handle
    ...
    methods
        ...
        function [best_k, accuracy, k_optimal] = runPipeline(obj, data, matchLengthMethod)
            ...
            [~, accuracy, k_optimal] = obj.knn_crossVal(X, y, Xnew, Ynew);
        ...
        function [Ypred, accuracy, best_k] = knn_crossVal(obj, X, y, Xnew, Ynew)
            ...
            k_val = 1:10; % Changed from 1:2:15 to match main.m
